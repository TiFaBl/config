...
# system basics
sudo apt install i3 gcc make cmake perl r-recommended python3 python3-venv pipenv flake8 python3-googleapi r-base git curl wget mplayer zsh emacspeak shellcheck markdown texlive-latex-base texlive-fonts-recommended texlive-fonts-extra texlive-latex-extra plantuml ripgrep fd-find docker.io docker-compose -y;
# emacs 
